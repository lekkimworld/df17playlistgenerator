...
app.post('/create_playlist', (req, res) => {
    ...
    youtubeApiRequest('/playlists', 
        access_token, 
        {
            'snippet': {
                'title': obj.name, 
                'description': 'Generated by Dreamforce 2017 Playlist Generator'
            }
        }
    ).then(resp => {
        ...
        let promises = obj['youtube_ids'].map(id => ({
            'snippet': {
            ...
            return youtubeApiRequest('/playlistItems', access_token, params)
        })
